	...
	var ProductTable = React.createClass({
	    ...
	    render: function render() {
	        var list = this.props.products.map(function (product) {
	            return React.createElement(ProductRow, { product: product, key: product.name });
	        });
	        return React.createElement(
	            'tbody',
	            null,
	            React.createElement(ProductCategoryRow, { category: this.props.category }),
	            list
	        );
	    }
	});
	...
	var ProductTableList = React.createClass({
	    ...
	    render: function render() {
	        ...
	        var products = this.props.products.filter(function (product) {
	            return !(product.name.indexOf(_this.props.filterText) === -1 || !product.stocked && _this.props.inStockOnly);
	        });
	        var categoryList = {};
	        var i = 0;
	        ...
	        for (var category in categoryList) {
	            if (categoryList.hasOwnProperty(category)) {
	                rows.push(React.createElement(ProductTable, { category: category, products: categoryList[category], key: categoryList[category].key }));
	            }
	        }
	...
	var SearchBar = React.createClass({
	    ...
	    render: function render() {
	        return React.createElement(
	            'form',
	            null,
	            React.createElement('input', { type: 'text', placeholder: 'Search...', value: this.props.filterText, ref: 'filterTextInput', onChange: this.handleInput }),
	            React.createElement(
	                'p',
	                null,
	                React.createElement('input', { type: 'checkbox', checked: this.props.inStockOnly, ref: 'inStockOnlyInput', onChange: this.handleInput }),
	                ' ',
	                'Only show products in stock'
	            ),
	            React.createElement(
	                Line,
	                { onUserClick: this.props.onUserInput },
	                'ball'
	            ),
	            React.createElement(
	                Line,
	...
	var FilterableProductTable = React.createClass({
	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            React.createElement(ProductTableList, { filterText: this.state.filterText, inStockOnly: this.state.inStockOnly, products: this.props.products })
	        );
	    }
	});
